...
export default function AboutPage() {
    ...
    const content = {
        en: {
            title: "About AffTraff",
            description: "AffTraff is a resource for webmasters and publishers looking to monetize their websites effectively. We provide comprehensive network reviews, industry news, and educational guides.",
        ...
        ru: {
            title: "Об AffTraff",
            description: "AffTraff — это ресурс для вебмастеров и издателей, стремящихся эффективно монетизировать свои сайты. Мы предоставляем комплексные обзоры сетей, новости индустрии и образовательные руководства.",
