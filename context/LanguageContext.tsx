...
const uiTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "article.editorsNote": "Editor's Note",
    "article.afftraffOpinion": "AffTraff Opinion",
    "article.ourExperience": "Our Experience",
    "article.related": "Related Articles",
    "article.views": "views",
    "article.readingTimeUnit": "min",
    "article.shareTitle": "Share this article",
    "article.shareSubtitle": "Send it to your audience or copy an AI-ready prompt.",
    "article.shareCopyLink": "Copy link",
    "article.shareX": "X",
    "article.shareTelegram": "Telegram",
    "article.shareLinkedIn": "LinkedIn",
    "article.shareFacebook": "Facebook",
    "article.shareAI": "Share to AI",
    "article.shareCopied": "Link copied.",
    "article.shareAICopied": "AI prompt copied.",
    "article.shareAIPrompt": "Read this article and give me a concise summary, key takeaways, and action items:\n\n{title}\n{url}",
    ...
    "knowledge.marketing": "Marketing",
    "knowledge.analytics": "Analytics",
    "knowledge.vertical": "Vertical",
    "knowledge.targeting": "Targeting",
    "knowledge.advertisement": "Advertisement",
    "knowledge.format": "Format",
    "knowledge.affiliate": "Affiliate",
  ...
  ru: {
    ...
    "article.editorsNote": "Мнение редакции",
    "article.afftraffOpinion": "Мнение AffTraff",
    "article.ourExperience": "Наш опыт",
    "article.related": "Похожие статьи",
    "article.views": "просмотров",
    "article.readingTimeUnit": "мин.",
    "article.shareTitle": "Поделиться статьёй",
    "article.shareSubtitle": "Отправьте её в соцсети или скопируйте AI-промпт.",
    "article.shareCopyLink": "Скопировать ссылку",
    "article.shareX": "X",
    "article.shareTelegram": "Telegram",
    "article.shareLinkedIn": "LinkedIn",
    "article.shareFacebook": "Facebook",
    "article.shareAI": "Поделиться с AI",
    "article.shareCopied": "Ссылка скопирована.",
    "article.shareAICopied": "AI-промпт скопирован.",
    "article.shareAIPrompt": "Прочитай эту статью и дай краткое резюме, ключевые выводы и практические действия:\n\n{title}\n{url}",
    ...
    "knowledge.marketing": "Маркетинг",
    "knowledge.analytics": "Аналитика",
    "knowledge.vertical": "Вертикаль",
    "knowledge.targeting": "Таргетинг",
    "knowledge.advertisement": "Реклама",
    "knowledge.format": "Формат",
    "knowledge.affiliate": "Арбитраж",
