...
import type { RankedLinkSelling } from "@/mock/rankings"
import { useLanguage } from "@/context/LanguageContext"
import { useAudience } from "@/context/AudienceContext"

interface LinkSellingTableProps {
  entries: RankedLinkSelling[]
  showRank?: boolean
  maxRows?: number
}

export default function LinkSellingTable({
  entries,
  showRank = true,
  maxRows,
}: LinkSellingTableProps) {
          ...
          {rows.map((item) => {
            ...
            return (
              ...
              >
                ...
                <td className="px-4 py-4">
                  <Link
                    href={`/${language}/${audience}/monetization/link-selling/${item.entry.slug}`}
