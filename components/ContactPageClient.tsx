            ...
            <div className="bg-white dark:bg-gray-800/50 border border-sky-200 dark:border-gray-700/50 rounded-xl p-6 shadow-sm">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full bg-sky-50 dark:bg-gray-900 border border-sky-200 dark:border-gray-700 rounded-lg px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-sky-500/20"
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    className="w-full bg-sky-50 dark:bg-gray-900 border border-sky-200 dark:border-gray-700 rounded-lg px-4 py-3 text-gray-900 dark:text-white resize-none focus:outline-none focus:ring-2 focus:ring-sky-500/20"
                    placeholder={active.messagePlaceholder}
                  />
                </div>
                <button
                  type="button"
                  className="w-full bg-sky-600 dark:bg-blue-600 hover:bg-sky-700 dark:hover:bg-blue-700 text-white font-medium py-3 rounded-lg transition-colors shadow-sm"
                >
                  {active.button}
                </button>
              </form>
