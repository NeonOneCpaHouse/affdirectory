...
export default function ToolsPageClient() {
  ...
  const toolsSubtitle = t("common.toolsSubtitle")
  const resolvedToolsSubtitle =
    toolsSubtitle !== "common.toolsSubtitle"
      ? toolsSubtitle
      : language === "ru"
        ? "Бесплатные инструменты для вашей работы"
        : "Free tools to optimize your workflow"
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-8 max-w-2xl">{resolvedToolsSubtitle}</p>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {tools.length === 0 && (
              <p className="col-span-2 text-center py-12 text-gray-500">
                {language === "ru"
                  ? "Инструменты для этой категории скоро появятся."
                  : "Tools for this category coming soon."}
              </p>
            )}
          </div>
        </div>
